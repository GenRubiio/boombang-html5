...
/**
 * Class CatalogCategoryCrudController
...
class CatalogCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/catalog-category');
        CRUD::setEntityNameStrings('catalog category', 'catalog categories');
    }
