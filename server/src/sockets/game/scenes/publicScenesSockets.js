...
const GetGameScenesController = require('../../../controllers/game/scenes/GetGameScenesController');
...
module.exports = (socket, io) => {
    ...
    socket.on(RequestSocketsEnum.GET_GAME_SCENES, () => {
        GetGameScenesController.main(socket, io);
    });
