@section('title'){{ (!is_array($object) && (isset($object->page_title) && empty($object->page_title)) ? $object->title . ' | ' . config('settings.name') : !is_array($object)) ? $object->page_title : '' }}@endsection
