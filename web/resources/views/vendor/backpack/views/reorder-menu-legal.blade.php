...
@section('content')
    <?php
    function numericOrderMenuLegal($entry, $key, $all_entries, $crud)
    {
        ...
        <div class="{{ $crud->getReorderContentClass() }}">
            <div class="card p-4">
                ...
                <ol class="sortable mt-0">
                    <?php
                    $all_entries = collect($entries->all())->sortBy('menu_legal_order');
                    $root_entries = $all_entries;
                    foreach ($root_entries as $key => $entry) {
                        $root_entries[$key] = numericOrderMenuLegal($entry, $key, $all_entries, $crud);
                    }
                    ?>
                </ol>
